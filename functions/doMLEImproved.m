function [ThetaMLEImproved, parMLEImproved, solMLEImproved, countMLEImproved] = doMLEImproved(getTrialPar, getTrialParImproved, solveModel, transformSolution, obs, par, Theta0, lb, ub, parsToOptimise, options)
...
objFn = @(Theta)(-calcLogLikImproved(getTrialParImproved, solveModel, transformSolution, obs, Theta, par, Theta0(parsToOptimise), lb(parsToOptimise), ub(parsToOptimise), options));
